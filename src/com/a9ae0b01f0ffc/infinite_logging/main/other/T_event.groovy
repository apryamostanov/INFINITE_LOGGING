...
class T_event extends T_logging_base_6_util {
    ...
    String get_datetimestamp() {
        return p_datetimestamp.format(GC_DATETIMESTAMP_FORMAT)
    }

    String get_message() {
        return tokenize(p_message, GC_MESSAGE_FORMAT_TOKEN_SEPARATOR_BEFORE, GC_MESSAGE_FORMAT_TOKEN_TRACE, get_traces_standalone())
    }
